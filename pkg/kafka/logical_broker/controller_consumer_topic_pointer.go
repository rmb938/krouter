...
func (c *Controller) CreateInternalTopics() error {
	...
	//  these topics should NEVER have more than 1 partition otherwise things will get out of order when loading state
	//  similar to schema registry
	internalTopics := []internalTopic{
		...
		},
		{
			...
			Partitions:        1, // TODO: this can have multiple partitions, not sure if we need them though
			ReplicationFactor: 1,
			Config: map[string]*string{
